...
| [Swift] ([Demo](with-swift))                                                               | A native Swift (iOS & Mac) example.                                                     |
| [Swift with `swift-graphql`] ([Demo][swift-graphql-demo])                                                              | A native Swift (iOS & Mac) example using [swift-graphql](swift-graphql).                                                     |
...
[swift]: with-swift
[swift-demo]: with-swift
[swift with `swift-graphql`]: with-swift-graphql
[swift-graphql-demo]: with-swift-graphql
